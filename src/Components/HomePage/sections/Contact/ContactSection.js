...
<Container className="text-center re-order">
                <Row>
                    ...
                    <h1 className="mobile-tab-header"><h1 className="section-heading">Contact <span style={{ color: "#b3b300" }}>Us</span></h1></h1>
                        <Image className="img-fluid hero-image" src={teamImage}></Image>
                    </Col>
                    <Col lg={6} md={12} sm={12} className="first">
                        <h1 className="desktop-header"><h1 className="section-heading">Contact <span style={{ color: "#b3b300" }}>Us</span></h1></h1>
