...
class LandingSection extends React.Component {
    ...
    registerForHackathon(){
        window.open("https://devfolio.co/external-apply/odetocode");
    }
